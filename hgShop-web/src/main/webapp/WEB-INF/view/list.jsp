	...
	<div class="container-fluid filter" style="margin:5px 15px">
			<div class="row">
				...
				<c:forEach items="${map.brandList}" var="brand">
					<div class="col-md-2 brand_list"><a href="list?brandId=${brand.id}&keyword=${keyword}">${brand.name}</a></div>
				</c:forEach>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-2 spec_option_list"><a href="list?optionId=${specOption.id}&keyword=${keyword}">${specOption.optionName}</a></div>
				</c:forEach>
			</div>
			</c:forEach>
		</div>
		...
		<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-3" style="text-align:center;padding:2px;">
						<a href="page?id=${spu.skuList[0].id}" id="sku${spu.id}" style="width: 50px;height: 50px;">
