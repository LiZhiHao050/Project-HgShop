    ...
    <div class="row" style="margin-bottom: 10px;">
        ...
        <div class="col-sm-12" align="right">
            ...
            <button class="btn btn-primary btn-sm" onclick="preAddSku()"
                    data-toggle="modal" data-target="#myModal">添加sku
            </button>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-info btn-sm" data-toggle="modal"
                                ...
                                onclick="getSkuById(${sku.id},1)">修改
                        </button>
                        <button class="btn btn-primary btn-sm" data-toggle="modal"
                                data-target="#myModal3"
                                onclick="getSkuById(${sku.id},2)">详情
                        </button>
                    </td>
                </tr>
            </c:forEach>
        ...
        <nav>
            <ul class="pagination">
                <c:if test="${pageInfo.hasPreviousPage}">
                    <li>
                        <a href="sku/skuList?pageNum=${pageInfo.prePage}&title=${sku.title}&sellPoint=${sku.sellPoint}">
                ...
                <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                    <c:if test="${pageInfo.pageNum==pageNum}">
                        <li class="active"><a
                                href="sku/skuList?pageNum=${pageNum}&title=${sku.title}&sellPoint=${sku.sellPoint}">${pageNum}</a>
                        </li>
                    </c:if>
                    <c:if test="${pageInfo.pageNum!=pageNum}">
                        <li>
                            <a href="sku/skuList?pageNum=${pageNum}&title=${sku.title}&sellPoint=${sku.sellPoint}">${pageNum}</a>
                        </li>
                    </c:if>
                </c:forEach>
                <c:if test="${pageInfo.hasNextPage}">
                    <li>
                        <a href="sku/skuList?pageNum=${pageInfo.nextPage}&title=${sku.title}&sellPoint=${sku.sellPoint}"
                           aria-label="Next">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="button" class="btn btn-info" value="增加下来选中规格及选项内容"
                                   onclick="addSpecAndSpecOption(1)"/>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" onclick="addSku(1)">添加</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
